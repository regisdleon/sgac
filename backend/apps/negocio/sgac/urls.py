...
urlpatterns = [
    ...
    path("profesorevaluacion", listar_profesores_evaluacion, name="profesorevaluacion-list"),
    path("profesorevaluacion/<int:pk>", detalle_profesores_evaluacion, name="profesorevaluacion-detail"),
